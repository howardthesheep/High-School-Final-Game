...
public class Driver implements GameVariables {
	 int arrayPos;
	static int i = 1;

    public static void main(String[] args) {
        JFrame frame = new JFrame("Chocolate Bro: The Game"); 
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ImageIcon favicon = new ImageIcon("C:\\Users\\Parker\\Documents\\NetBeansProjects\\Bro the Game 2\\src\\bro\\the\\game\\pkg2\\Bro Can.png");
        Image faviconImage = (favicon.getImage());
        frame.setPreferredSize(new Dimension(800,600));
    
        frame.setIconImage(faviconImage);
